<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="sachtheoloai.aspx.cs" Inherits="WebApplication1.sachtheoloai" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
         ...
         <div class="df" >
                <div class="df_1">
                    <% 
                            ...
                            {%>
                                <a class="a_decoration df_item" href="sachtheoloai.aspx?ml=<%= matheloaiList[i]%>"><%= tentheloaiList[i]%></a><hr />
                            <%}
    ...
    %>
                <div  style="margin-top: 10px;width:30%;margin-left:10px">
                    ...
                    <div class="hover-sanpham" style="display: flex;width:90%;box-shadow: 0px 0px 5px -2px;align-items: center;flex-direction: column; background-color:white; border-radius:5px;">
